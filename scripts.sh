...
cd /Users/teatec/Documents/GitHub/bibliotech && npm run build 2>&1 | tail -20

# Limpar cache do projeto para garantir que as últimas mudanças sejam refletidas corretamente.
cd /Users/teatec/Documents/GitHub/bibliotech && npm cache clean --force

# Iniciar projeto
cd /Users/teatec/Documents/GitHub/bibliotech && npm start
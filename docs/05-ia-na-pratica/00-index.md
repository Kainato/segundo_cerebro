...
- Métodos e abordagens para implementação de soluções com IA
- Desenvolvimento de seus primeiros projetos com IA
- Criação de agentes inteligentes
- Guias completos para iniciantes na área

## Créditos e Referências

Este conteúdo foi desenvolvido com base na **Imersão Inteligência Artificial na Prática**, ministrada por **Lorenzo** pela **DAXUS**.

    ...
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className="container">
        ...
        <p style={{ fontSize: "1.1rem", marginTop: "1rem", lineHeight: "1.6" }}>
          Este espaço documenta minha evolução técnica, detalha meus projetos
          com propósito e serve como guia estruturado para transformar
          "repositórios parados" em
...
function ContentSection() {
  return (
    <section
      style={{ padding: "2rem 0", textAlign: "center", marginTop: "2rem" }}
    >
      <div className="container">
        ...
        >
          ...
          >
            ...
            <p>
              Cada projeto é documentado com <strong>desafio</strong>,{" "}
              <strong>aprendizado</strong> e <strong>próximos passos</strong>.
              Não apenas código, mas narrativa.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Projetos agrupados por workshops ou temas, mostrando a evolução do
          ...
          >
            ...
            <p>
              Cada projeto é um passo na jornada de aprendizado, mostrando não
              apenas o que foi feito, mas o que foi aprendido e o que vem a
              seguir.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Explicar com suas próprias palavras (Técnica de Feynman) fixa o
              aprendizado muito mais do que apenas assistir a aulas.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Cada projeto vinculado com créditos ao curso/instrutor.
              Conhecimento compartilhado, origem respeitada.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Uma wiki pessoal bem estruturada conta mais sobre sua maturidade
              técnica do que 10 cursos completados isoladamente.
            </p>
          </div>
        </div>
      </div>
